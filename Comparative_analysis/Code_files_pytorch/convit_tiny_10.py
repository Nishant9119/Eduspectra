...
checkpoint_path = r"/home/ied10015.21/skincancer/convit_tiny.pth"
# Load Dataset
...
model = create_model('convit_tiny',pretrained =False,num_classes=2)
...
print(f"Model convit_tiny epoch 10---------------------------------------")
# Training Loop
num_epochs =10
